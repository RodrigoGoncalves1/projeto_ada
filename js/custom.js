(function () {
	...
	var tinyslier = function() {
		...
		var destinationSlider = document.querySelectorAll('.destination-slider-2');

		if ( destinationSlider.length > 0 ) {
			var desSlider = tns({
				container: ".destination-slider-2",
				mouseDrag: true,
				items: 1,
				axis: "horizontal",
				swipeAngle: false,
		...
		var destinationSlider = document.querySelectorAll('.destination-slider-3');

		if ( destinationSlider.length > 0 ) {
			var desSlider = tns({
				container: ".destination-slider-3",
				mouseDrag: true,
				items: 1,
				axis: "horizontal",
				swipeAngle: false,
